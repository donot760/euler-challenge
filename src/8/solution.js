function largestProductinaSeries(n) {
    ...
    for (let i = 0; i < thousandDigits.length-n; i++) {
        // get the n consecutive digits starting at index i
        const nDigits = thousandDigits.slice(i, i+n);
        const productOfDigits = nDigits.reduce((x,y) => x*y, 1);
        if (productOfDigits > largestProductSoFar) {
            largestProductSoFar = productOfDigits;
        }
    }
